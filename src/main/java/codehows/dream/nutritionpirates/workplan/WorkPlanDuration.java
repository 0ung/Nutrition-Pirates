...
public class WorkPlanDuration {
	...
	public double mixDuration(int input) {
		int kg = Routing.MIX_ROUTING;
		double time = Routing.MIX_ROUTING_TIME;
		return timeCal(input, kg, time);
	}
	...
	public double inspectionWaiting(int input) {
		return Routing.INSPECTION_WAITING_TIME;
	}

	public double boxPackingWaiting(int input) {
		return Routing.BOX_PACKING_WAITING_TIME;
	}

	public double juicePackingWaiting(int input) {
		return Routing.JUICE_WAITING_TIME;
	}

	public double stickPackingWaiting(int input) {
		return Routing.STICK_WAITING_TIME;
	}
	...
	public double mixWaiting(int input) {
